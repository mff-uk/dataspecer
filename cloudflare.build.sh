...
printf "NEXT_PUBLIC_BASE_PATH=/conceptual-model-editor" > applications/conceptual-model-editor/.env

npx turbo run build --scope=client --scope=conceptual-model-editor
