...
- `Edge` - Connects two nodes. Again multiple types.
  ...
  - Edge representing generalization ![img.png](generalization-edge.png)
  ...
  ![img.png](profile-to-class-profile-edge.png)
...
![img_4.png](create-new-visual-model-button.png)
...
![img_4.png](change-visual-model.png)
...
![img_6.png](catalog-vocabulary-visibility-v2.png)
...
![img_5.png](catalog.png)

#### Target button

![img_7.png](target_button2.png)
...
![img_5.png](show_neighborhood.png)

![img_7.png](show_neighborhood2.png)
...
![img_8.png](node-actions.png)

#### Duplication
![img_9.png](node-actions-duplication.png)
...
![img_9.png](attribute-buttons-on-node.png)
...
![img_9.png](edit-attribute-visibility-button.png)
...
![img_10.png](edit-attributes-visibility-dialog.png)
...
![img_10.png](anchor-node-button.png)
...
![img_10.png](anchored-node-example.png)
...
- It may be also useful if we want for example node and its neighborhood to layout it like star ![img.png](star-layout-force-directed.png)
...
![img.png](extend-selection-example-start.png)
...
#### Start state:
![img.png](profile-selection-start-state.png)

Note: The class profile and profiled class share position. On the left and on the right

#### Case 1:

![img.png](profile-selection-without-profiling-shared-end.png)


#### Case 2:


![img.png](profile-selection-with-profiling-shared-end.png)
...
![img_10.png](creating-visual-diagram-node-from-existing.png)
...
![img_10.png](creating-visual-diagram-node-new.png)
...
![img_10.png](put-all-edges-related-to-visual-diagram-node-on-canvas-button.png)
- 🗺️ button changes active visual model (that is the one that is shown) to the one represented by the visual node.

![img_10.png](move-to-represented-visual-model-button.png)
...
![img_10.png](put-represented-visual-diagram-on-canvas-and-remove-visual-diagram-node.png)
...
![img_6.png](elk-stress-dcat-ap.png)
...
![img_6.png](cluster-alg-dcat-ap-without-edge-layout.png)

Layouted DCAT-AP using cluster based algorithm with edge layout of clusters:

![img_6.png](cluster-alg-dcat-ap-with-edge-layout.png)
...
![img_6.png](random-dcat-ap-without-node-overlap.png)

Layouted DCAT-AP using random algorithm with node overlap removal:
![img_6.png](random-dcat-ap-with-node-overlap.png)
...
![img_6.png](layered-algorithm-dcat-ap.png)
...
- Edge routing type
  - Orthogonal - ![img.png](orthogonal-edge-routing.png)
  - Splines - ![img.png](splines-edge-routing.png)
  - Polylines - ![img.png](polylines-edge-routing.png)
