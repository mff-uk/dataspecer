...
export const Help: FC = () => {
    ...
    return <>
        <ButtonGroup variant="contained" ref={anchorRef} sx={{backgroundColor: theme => theme.palette.warning.main}}>
            ...
            <HelpButton target="_blank" href={import.meta.env.VITE_BUG_TRACKER_URL}>{t("report a bug")}</HelpButton>
            <HelpButton
                size="small"
                onClick={open}
            >
        ...
        >
            {({ TransitionProps, placement }) => (
                <ClickAwayListener onClickAway={close}>
                    ...
                    >
                        {/* @ts-ignore target undefined */}
                        <HelpButton target="_blank" href={import.meta.env.VITE_FEATURE_TRACKER_URL}>{t("request a feature")}</HelpButton>
                    </Grow>
                </ClickAwayListener>
            )}
        </Popper>
