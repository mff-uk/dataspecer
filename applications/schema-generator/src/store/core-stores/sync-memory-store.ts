import {CoreOperation, CoreOperationExecutor, CoreOperationResult, CoreResource, CoreResourceReader, CoreResourceWriter, CreateNewIdentifier, MemoryStore} from "@model-driven-data/core/lib/core";
