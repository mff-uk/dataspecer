...
import {writeJsonSchema} from "@model-driven-data/core/lib/json-schema/json-schema-writer";
...
import {structureModelToJsonSchema} from "@model-driven-data/core/lib/json-schema/json-schema-model-adapter";
