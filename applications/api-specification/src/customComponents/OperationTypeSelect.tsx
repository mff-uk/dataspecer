...
const OperationTypeSelect: React.FC<OperationTypeSelectProps> = ({
    ...
    return (
        <>
            ...
            {/* {dataStructure && isCollection && associationModeOn && selectedResponseObject ? (
                <div>
                    <p>Suggested Path: {pluralizeAndNoSpaces(dataStructure)}/{`{id}`}/{pluralizeAndNoSpaces(selectedResponseObject)}</p>
                </div>
            ) : dataStructure && !isCollection && associationModeOn && selectedResponseObject ? (
                <div>
                    <p>Suggested Path: {pluralizeAndNoSpaces(dataStructure)}/{`{id}`}/{pluralizeAndNoSpaces(selectedResponseObject)}/{`{id}`}</p>
                </div>
            ) : dataStructure && isCollection && !associationModeOn ? (
                <div>
                    <p>Suggested Path: {pluralizeAndNoSpaces(dataStructure)}</p>
