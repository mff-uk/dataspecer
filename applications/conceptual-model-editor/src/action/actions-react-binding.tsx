...
function createActionsContext(
  ...
  const addNodeToVisualModel = async (model: string, identifier: string) => {
    const position = await findPositionForNewNodeUsingLayouting(notifications, diagram, graph, classes, identifier);
