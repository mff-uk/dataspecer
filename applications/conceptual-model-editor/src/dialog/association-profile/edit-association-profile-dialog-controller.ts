...
export interface EditAssociationProfileDialogState extends EntityState, CreateEntityState, ProfileState {
...
export interface EditAssociationProfileDialogController extends EntityStateController, CreateEntityStateController, ProfileStateController {
...
function validate(state: EditAssociationProfileDialogState): EditAssociationProfileDialogState {
