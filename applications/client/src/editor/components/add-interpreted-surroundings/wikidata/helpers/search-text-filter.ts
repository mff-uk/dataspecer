...
export function entitySearchTextFilterWithMap<T extends WdEntityDescOnly>(searchText: string | undefined, entitiesIds: WdEntityIdsList, entitiesMap: ReadonlyMap<WdEntityId, T>): WdEntityIdsList {
...
export function entitySearchTextFilter<T extends WdEntityDescOnly>(searchText: string | undefined, entities: T[]): T[] {
