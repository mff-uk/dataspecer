...
test(testNamePrefix + "add prefix", async () => {
    ...
    query.prefixes = {};
    const newPrefix = addPrefix("https://slovník.gov.cz/datový/číselníky/pojem/", query.prefixes);
...
test(testNamePrefix + "add prefixes", async () => {
    const query = new SparqlSelectQuery();
    query.prefixes = {};
    addPrefix("https://slovník.gov.cz/datový/číselníky/dojem/", query.prefixes);
    addPrefix("https://slovník.gov.cz/datový/číselníky/hnojem/", query.prefixes);
    const newPrefix = addPrefix("https://slovník.gov.cz/datový/číselníky/pojem/", query.prefixes);
...
test(testNamePrefix + "add same prefixes", async () => {
    ...
    query.prefixes = {};
    addPrefix("https://slovník.gov.cz/datový/číselníky/dojem/", query.prefixes);
    addPrefix("https://slovník.gov.cz/datový/číselníky/pojem/", query.prefixes);
    const newPrefix = addPrefix("https://slovník.gov.cz/datový/číselníky/dojem/", query.prefixes);
    expect(newPrefix).toBe("ns1");
});
...
test(testNamePrefix + "add well-known prefix", async () => {
    const query = new SparqlSelectQuery();
    query.prefixes = {};
    const newPrefix = addPrefix("http://www.w3.org/1999/02/22-rdf-syntax-ns#", query.prefixes);
...
test(testNamePrefix + "add well-known prefixes", async () => {
    const query = new SparqlSelectQuery();
    query.prefixes = {};
    addPrefix("http://www.w3.org/1999/02/22-rdf-syntax-ns#", query.prefixes);
    const newPrefix = addPrefix("http://purl.org/dc/terms/", query.prefixes);
