...
import { StructureModelComplexType, StructureModelPrimitiveType, StructureModelType } from "@dataspecer/core/structure-model/model/structure-model-type";
...
export class LdkitSchemaAdapter implements StructureClassToSchemaAdapter {
    ...
    convertAttributeDataTypeToLdkitSupportedDataType<T>(dataTypeIri: string): keyof T {
        const map: { [k: string]: any } = {
            ...
            "https://ofn.gov.cz/zdroj/z%C3%A1kladn%C3%AD-datov%C3%A9-typy/2020-07-01/celé-číslo": xsd.integer,
            "https://ofn.gov.cz/zdroj/z%C3%A1kladn%C3%AD-datov%C3%A9-typy/2020-07-01/desetinné-číslo": xsd.decimal,
            "https://ofn.gov.cz/zdroj/z%C3%A1kladn%C3%AD-datov%C3%A9-typy/2020-07-01/url": xsd.anyURI,
            "https://ofn.gov.cz/zdroj/z%C3%A1kladn%C3%AD-datov%C3%A9-typy/2020-07-01/řetězec": xsd.string,
            "https://ofn.gov.cz/zdroj/z%C3%A1kladn%C3%AD-datov%C3%A9-typy/2020-07-01/text":  rdf.langString
        }
