import { SourceCodeWriter, SourceCodeLanguageIdentifier } from "../writers/source-code-writer-model.ts";
import { TypescriptWriter } from "../writers/typescript-writer.ts";
